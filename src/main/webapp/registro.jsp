...
<main id="contenido" class="container d-flex justify-content-center align-items-center py-5"
    ...
    <div class="card panel-oscuro p-4 p-md-5" style="max-width: 480px; width: 100%;">
        <div class="text-center mb-4">
            ...
            <p class="text-secondary mb-0">Registrate como estudiante explorador</p>
        </div>
        ...
        <form action="${ctx}/registrar" method="post">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Debe ser un correo electronico valido.</div>
            </div>
            <div class="mb-3">
        ...
        <p class="text-center text-secondary mb-0">
            Ya tienes cuenta?
            <a href="${ctx}/login.jsp" class="texto-oro">Inicia sesion</a>
        </p>
